...
describe('<ContainerTemperature />', () => {
  it('renders the container\'s temperature range', () => {
    const container = { beer: 'Beer 1', temperature: 5, minTemperature: 4, maxTemperature: 6, outOfRange: false };
  ...
  describe('waiting thermometer', () => {
    it('renders "waiting thermometer" for containers without temperature', () => {
      const container = { beer: 'Beer 1', temperature: null, minTemperature: 4, maxTemperature: 6, outOfRange: false };
      const wrapper = mount(<ContainerTemperature {...container}/>);
  ...
  describe('out of range', () => {
    it('adds outOfRange class for outOfRange containers', () => {
      const container = { beer: 'Beer 1', temperature: 7, minTemperature: 4, maxTemperature: 6, outOfRange: true };
    ...
    it('doesn\'t add outOfRange class for not outOfRange containers', () => {
      const container = { beer: 'Beer 1', temperature: 7, minTemperature: 4, maxTemperature: 6, outOfRange: false };
      const wrapper = shallow(<ContainerTemperature {...container}/>);
  ...
  describe('toast', () => {
    ...
    it('toasts out of range containers on update', () => {
      ...
      expect(toast.warn).toHaveBeenCalledWith('Beer 1 is out of temperature range!');
    });
